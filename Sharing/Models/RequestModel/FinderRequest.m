...
-(void)requestFinder:(NSString *)key meId:(NSString *)meId type:(NSString *)type limt:(NSString *)limt{
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        // 耗时的操作
        ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:[[NSURL alloc]initWithString:REQUEST_FINDER_URL]];
        request.timeOutSeconds = 20;
        
        NSDictionary *postValue = @{@"dream":@{@"key":key,@"id":meId,@"type":type,@"limit":limt}};
