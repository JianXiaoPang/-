...
- (NSString *)uniqueGlobalDeviceIdentifier
{
    NSString *uniqueIdentifierStr = [[NSUserDefaults standardUserDefaults] stringForKey:@"hfw_imei"];
...
//        uniqueIdentifierStr = [[adId stringByReplacingOccurrencesOfString:@"-" withString:@""] lowercaseString];
    ...
    if (uniqueIdentifierStr)
    {
        [[NSUserDefaults standardUserDefaults] setObject:uniqueIdentifierStr forKey:@"hfw_imei"];
    }
    return uniqueIdentifierStr;
}
