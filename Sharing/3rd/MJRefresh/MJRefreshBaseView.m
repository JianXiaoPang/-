...
//    self.arrowImage.center = CGPointMake(arrowX, self.mj_height * 0.5-10);
    self.arrowImage.frame = CGRectMake(arrowX, self.mj_height * 0.5-20, 40, 40);
    // 2.指示器
    ...
    switch (state) {
		case MJRefreshStateNormal: // 普通状态
        {
            if (oldState == MJRefreshStateRefreshing) {
                // 正在结束刷新
                _endingRefresh = YES;
                NSMutableArray *animateArray = [NSMutableArray arrayWithObjects:[UIImage imageNamed:@"loading02.png"], [UIImage imageNamed:@"loading01.png"],nil];
                self.arrowImage.animationImages = animateArray;
                self.arrowImage.animationDuration = 0.6;
...
//                }];
		...
		case MJRefreshStateRefreshing:
        {
            ...
            NSMutableArray *animateArray = [NSMutableArray arrayWithObjects:[UIImage imageNamed:@"loading02.png"], [UIImage imageNamed:@"loading01.png"],nil];
            self.arrowImage.animationImages = animateArray;
            self.arrowImage.animationDuration = 1.0;
            [self.arrowImage startAnimating];
