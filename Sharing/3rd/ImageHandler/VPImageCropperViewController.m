...
//    CGFloat oriHeight = self.originalImage.size.height * (oriWidth / self.originalImage.size.width);
    CGFloat oriWidth = self.view.frame.size.width;
    CGFloat smallWidth = self.cropFrame.size.width;
    CGFloat smallHeight  = self.originalImage.size.height * (smallWidth / self.originalImage.size.width);
    CGFloat oriHeight = self.originalImage.size.height * (oriWidth / self.originalImage.size.width);
    ...
    self.smallFrame = CGRectMake(oriX, oriY, smallWidth, smallHeight);
